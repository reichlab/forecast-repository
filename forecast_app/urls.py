...
urlpatterns = [
    ...
    url(r'^project/(?P<project_pk>\d+)/json', views.download_json_for_model_with_cdc_data,
    ...
    url(r'^forecast/(?P<forecast_pk>\d+)/json', views.download_json_for_model_with_cdc_data,
