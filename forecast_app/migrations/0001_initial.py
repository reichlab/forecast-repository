# -*- coding: utf-8 -*-
# Generated by Django 1.11 on 2019-11-19 18:12
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('lwr', models.FloatField(null=True)),
                ('prob', models.FloatField()),
            ],
            options={
                'abstract': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('step_ahead_increment', models.IntegerField(default=0, help_text="Optional field that's required when Target.is_step_ahead is True, is an integer specifying how many time steps ahead the Target is. Can be negative, zero, or positive.")),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('target', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='binlwrs', to='forecast_app.Target')),
            ],
        ),
        migrations.CreateModel(
            name='TimeZero',
