    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('model_owners', models.ManyToManyField(help_text='Users who are allowed to create, edit, and delete ForecastModels in this project.', to=settings.AUTH_USER_MODEL)),
