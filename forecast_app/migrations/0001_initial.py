# -*- coding: utf-8 -*-
# Generated by Django 1.11 on 2019-01-31 20:09
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.CharField(help_text='A few paragraphs describing the model. Please see documentation for what should be included here - information on reproducing the model’s results, etc.', max_length=2000)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('unit', models.CharField(blank=True, help_text="This target's units, e.g., 'percentage', 'week', 'cases', etc.", max_length=200)),
