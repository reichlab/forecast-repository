# -*- coding: utf-8 -*-
# Generated by Django 1.11.6 on 2017-12-13 18:09
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_public', models.BooleanField(default=True, help_text="False if the project is private and can only be accessed by the project's owner or any of its model_owners. True means it's publicly accessible.")),
                ('name', models.CharField(max_length=200)),
