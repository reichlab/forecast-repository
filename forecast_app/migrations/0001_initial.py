# -*- coding: utf-8 -*-
# Generated by Django 1.11 on 2020-02-12 17:50
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('family', models.IntegerField(choices=[(0, 'Normal'), (1, 'Log Normal'), (2, 'Gamma'), (3, 'Beta'), (4, 'Binomial'), (5, 'Poisson'), (6, 'Negative Binomial'), (7, 'Negative Binomial 2')])),
