# -*- coding: utf-8 -*-
# Generated by Django 1.11 on 2020-03-05 20:05
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('family', models.IntegerField(choices=[(0, 'Normal'), (1, 'Log Normal'), (2, 'Gamma'), (3, 'Beta'), (4, 'Poisson'), (5, 'Negative Binomial'), (6, 'Negative Binomial 2')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('value_b', models.NullBooleanField()),
                ('forecast', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='forecast_app.Forecast')),
            ],
            options={
                'abstract': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sample_b', models.NullBooleanField()),
                ('forecast', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='forecast_app.Forecast')),
            ],
            options={
                'abstract': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('type', models.IntegerField(choices=[(0, 'continuous'), (1, 'discrete'), (2, 'nominal'), (3, 'binary'), (4, 'date')], help_text="The Target's type. The choices are 'continuous', 'discrete', 'nominal', 'binary', and 'date'.")),
        ...
        migrations.AddField(
            model_name='unit',
            name='project',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='units', to='forecast_app.Project'),
        ),
        migrations.AddField(
            model_name='truthdata',
            name='unit',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='forecast_app.Unit'),
        ),
        migrations.AddField(
            model_name='timezero',
            name='project',
        ...
        migrations.AddField(
            model_name='scorevalue',
            name='unit',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='forecast_app.Unit'),
        ),
        migrations.AddField(
