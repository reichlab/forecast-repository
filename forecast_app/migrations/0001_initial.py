# -*- coding: utf-8 -*-
# Generated by Django 1.11.6 on 2017-11-06 13:39
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('auxiliary_data', models.URLField(blank=True, help_text='Optional model-specific directory or Zip file containing data files (e.g., CSV files) beyond Project.core_data that were used by this model.', null=True)),
            ],
        ),
        migrations.CreateModel(
            name='Project',
            fields=[
                ...
                ('owner', models.ForeignKey(blank=True, help_text="The project's owner.", null=True, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'abstract': False,
            },
