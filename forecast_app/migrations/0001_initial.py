# -*- coding: utf-8 -*-
# Generated by Django 1.11.3 on 2017-10-12 13:47
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='ModelWithCDCData',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('csv_filename', models.CharField(help_text="Original CSV file name of this forecast's data source", max_length=200)),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            name='Forecast',
            fields=[
                ('modelwithcdcdata_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='forecast_app.ModelWithCDCData')),
            ],
            bases=('forecast_app.modelwithcdcdata',),
        ),
        migrations.CreateModel(
            name='Project',
            fields=[
        ...
        migrations.AddField(
            ...
            name='forecast',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='cdcdata_set', to='forecast_app.Forecast'),
        ),
        migrations.AddField(
            model_name='forecast',
            name='forecast_model',
        ...
        migrations.AddIndex(
            model_name='projecttemplatedata',
            index=models.Index(fields=['location', 'target', 'row_type', 'unit'], name='forecast_ap_locatio_722b86_idx'),
        ),
        migrations.AddIndex(
            model_name='forecastdata',
            index=models.Index(fields=['location', 'target', 'row_type', 'unit'], name='forecast_ap_locatio_ffc4e1_idx'),
        ),
    ]
